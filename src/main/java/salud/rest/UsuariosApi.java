...
public interface UsuariosApi {
	...
	@Operation(summary = "Agregar alertas", description = "Agrega alertas a un usuario")
	...
	@Operation(summary = "Eliminar alerta", description = "Elimina una alerta de un usuario")
	@DeleteMapping("/{idUsuario}/alertas/{idAlerta}")
	@PreAuthorize("hasAuthority('USUARIO')")
