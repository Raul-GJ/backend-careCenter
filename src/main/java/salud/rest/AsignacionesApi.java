...
public interface AsignacionesApi {
	...
	@PostMapping
	public ResponseEntity<Void> agregarAsignacion(@Valid @RequestBody AsignacionEstudioDto asignacionDto) 
			throws EntidadNoEncontrada;
	
	@Operation(summary = "Modificar asignacion", description = "Modifica los datos de una asignación")
	@PatchMapping("{id}")
	public ResponseEntity<Void> modificarAsignacion(@PathVariable String id,
	...
	@DeleteMapping("{id}")
	public ResponseEntity<Void> eliminarAsignacion(@PathVariable String id) throws EntidadNoEncontrada;
	
	@Operation(summary = "Obtener asignacion", description = "Obtiene una asignación a partir de su id")
	@GetMapping("{id}")
	public ResponseEntity<AsignacionEstudioDto> obtenerAsignacion(@PathVariable String id) 
			throws EntidadNoEncontrada;
	...
	public ResponseEntity<Collection<AsignacionEstudioDto>> obtenerEspecialistas(String id) 
			throws EntidadNoEncontrada;
	...
	public ResponseEntity<Collection<AsignacionEstudioDto>> obtenerEstudios(String id) 
			throws EntidadNoEncontrada;
}
